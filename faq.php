...
if ($CURUSER)
{
    ...
    {
        $byboth = $byratio && $byul;
        echo(($byboth ? 'both ' : '').($byratio ? 'your ratio of '.format_ratio($CURUSER['uploaded'], $CURUSER['downloaded']) : '').($byboth ? ' and ' : '').($byul ? 'your total uploaded of '.round($gigs, 2).' GB' : '').' impl'.($byboth ? 'y' : 'ies').' a delay of $wait hours.'.($byboth ? '' : ' (Even if your '.($byratio ? 'total uploaded is '.round($gigs, 2).' GB' : 'ratio is '.format_ratio($CURUSER['uploaded'], $CURUSER['downloaded'])).'.)'));
    }
    else
    {
...
This applies to new users as well, so opening a new account will not help. Note also that this works at tracker level,
you will be able to grab the .torrent file itself at any time.<br />
<br />
...
N.B. Due to some users exploiting the 'no-delay-for-seeders' policy we had to change it. The delay now applies to both
seeding and leeching. So if you are subject to a delay and get the files from some other source you will not be able to
seed them until the delay has elapsed.<br />
<br />
<br />
<span style='font-weight:bold;'>Why do I get a &quot;rejected by tracker - Port xxxx is blacklisted&quot; error?</span><a
        name='dl9'></a><br />
<br />
Your client is reporting to the tracker that it uses one of the default bittorrent ports (6881-6889) or any other common
p2p port for incoming connections.<br />
<br />
<span style='font-weight:bold;'><?php echo $site_name?></span> does not allow clients to use ports commonly associated
with p2p protocols. The reason for this is that it is a common practice for ISPs to throttle those ports (that is, limit
the bandwidth, hence the speed). <br />
<br />
...
<table cellspacing='3' cellpadding='0'>
    <tr>
        ...
        <td class='embedded' width='80' bgcolor='#F5F4EA'>
            <div align='center'>411 - 413</div>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class='embedded' width='80' bgcolor='#F5F4EA'>
            <div align='center'>6346 - 6347</div>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class='embedded' width='80' bgcolor='#F5F4EA'>
            <div align='center'>6881 - 6889</div>
        </td>
    </tr>
</table>

<br />
In order to use use our tracker you must configure your client to use any port range that does not contain those ports
(a range within the region 49152 through 65535 is preferable. <a class='altlink'
                                                                 href='http://www.iana.org/assignments/port-numbers'>IANA</a>).
Notice that some clients, like Azureus 2.0.7.0 or higher, use a single port for all torrents, while most others use one
port per open torrent. The size of the range you choose should take this into account (typically less than 10 ports
wide. There is no benefit whatsoever in choosing a wide range, and there are possible security implications).<br />
<br />
These ports are used for connections between peers, not client to tracker. Therefore this change will not interfere with
your ability to use other trackers (in fact it should <span style='font-style: italic;'>increase</span> your speed with
torrents from any tracker, not just ours). Your client will also still be able to connect to peers that are using the
standard ports. If your client does not allow custom ports to be used, you will have to switch to one that does.<br />
<br />
Do not ask us, or in the forums, which ports you should choose. The more random the choice is the harder it will be for
ISPs to catch on to us and start limiting speeds on the ports we use. If we simply define another range ISPs will start
throttling that range also. <br />
<br />
Finally, remember to forward the chosen ports in your router and /or open them in your firewall, should you have them.
See the <span style='font-style: italic;'><a href='#user8a' class='altlink'>Why am I listed as not
                                                                            connectable?</a></span> &nbsp;section
and links therein for more information on this.<br />
<br />
<br />
<span style='font-weight:bold;'>What's this 'IOError - [Errno13] Permission denied' error?</span><a
        name='dla'></a><br />
<br />
If you just want to fix it reboot your computer, it should solve the problem. Otherwise read on.<br />
<br />
IOError means Input-Output Error, and that is a file system error, not a tracker one. It shows up when your client is
for some reason unable to open the partially downloaded torrent files. The most common cause is two instances of the
client to be running simultaneously: the last time the client was closed it somehow didn't really close but kept running
in the background, and is therefore still locking the files, making it impossible for the new instance to open
them.<br />
<br />
A more uncommon occurrence is a corrupted FAT. A crash may result in corruption that makes the partially downloaded
files unreadable, and the error ensues. Running scandisk should solve the problem. (Note that this may happen only if
you're running Windows 9x - which only support FAT - or NT/2000/XP with FAT formatted hard drives. NTFS is much more
robust and should never permit this problem.)<br />
<br />
<br />
<span style='font-weight:bold;'>What's this &quot;TTL&quot; in the browse page?</span><a name='dlb'></a><br />
<br />
The torrent's Time To Live, in hours. It means the torrent will be deleted from the tracker after that many hours have
elapsed (yes, even if it is still active). Note that this a maximum value, the torrent may be deleted at any time if
it's inactive.<br />
</td>
</tr>
</table>
            ...
            <table border='1' width='100%' cellspacing='0' cellpadding='10'>
                <tr>
                    <td class='text'>
                        ...
                        <br />
                        (Proselytising side note: make sure you remember that you did not enjoy the low speed. <span
                            style='font-weight:bold;'>Seed</span> so that others will not endure the same.)<br />
                        <br />
                        There are a couple of things that you can try on your end to improve your speed:<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Do not immediately jump on new torrents</span><a
                            name='dlsp1'></a><br />
                        <br />
                        In particular, do not do it if you have a slow connection. The best speeds will be found around
                        the half-life of a torrent, when the SLR will be at its highest. (The downside is that you will
                        not be able to seed so much. It's up to you to balance the pros and cons of this.)<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Make yourself connectable</span> <a name='dlsp2'></a><br />
                        <br />
                        See the <span style='font-style: italic;'><a href='#user8a' class='altlink'>Why am I listed as
                                                                                                    not connectable?</a></span>
                        &nbsp;section.<br />
                        <br />
                        <br />
                        ...
                        <ul>
                            <li>Bittorrent peers tend to favour those other peers that upload to them. This means that
                                if A and B are leeching the same torrent and A is sending data to B at high speed then B
                                will try to reciprocate. So due to this effect high upload speeds lead to high download
                                speeds.
                            </li>

                            <li>Due to the way TCP works, when A is downloading something from B it has to keep telling
                                B that it received the data sent to him. (These are called acknowledgements - ACKs -, a
                                sort of &quot;got it!&quot; messages). If A fails to do this then B will stop sending
                                data and wait. If A is uploading at full speed there may be no bandwidth left for the
                                ACKs and they will be delayed. So due to this effect excessively high upload speeds lead
                                to low download speeds.
                            </li>
                        </ul>

                        The full effect is a combination of the two. The upload should be kept as high as possible while
                        allowing the ACKs to get through without delay. <span style='font-weight:bold;'>A good thumb rule is keeping the upload at about 80% of the theoretical upload speed.</span>
                        ...
                        <br />
                        If you are running more than one instance of a client it is the overall upload speed that you
                        must take into account. Some clients (e.g. Azureus) limit global upload speed, others (e.g.
                        Shad0w's) do it on a per torrent basis. Know your client. The same applies if you are using your
                        connection for anything else (e.g. browsing or FTP), always think of the overall upload
                        speed.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Limit the number of simultaneous connections</span><a
                            name='dlsp4'></a><br />
                        <br />
                        Some operating systems (like Windows 9x) do not deal well with a large number of connections,
                        and may even crash.
                        Also some home routers (particularly when running NAT and /or firewall with stateful inspection
                        services) tend to become slow or crash when having to deal with too many connections. There are
                        no fixed values for this, you may try 60 or 100 and experiment with the value. Note that these
                        numbers are additive, if you have two instances of
                        a client running the numbers add up.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Limit the number of simultaneous uploads</span><a
                            name='dlsp5'></a><br />
                        <br />
                        Isn't this the same as above? No. Connections limit the number of peers your client is talking
                        to and /or downloading from. Uploads limit the number of peers your client is actually uploading
                        to. The ideal number is typically much lower than the number of connections, and highly
                        dependent on your (physical) connection.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Just give it some time</span><a name='dlsp6'></a><br />
                        <br />
                        As explained above peers favour other peers that upload to them. When you start leeching a new
                        torrent you have
                        nothing to offer to other peers and they will tend to ignore you. This makes the starts slow, in
                        particular if,
                        by change, the peers you are connected to include few or no seeders. The download speed should
                        increase as soon
                        as you have some pieces to share.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Why is my browsing so slow while leeching?</span><a
                            name='dlsp7'></a><br />
                        <br />
                        Your download speed is always finite. If you are a peer in a fast torrent it will almost
                        certainly saturate your
                        download bandwidth, and your browsing will suffer. At the moment there is no client that allows
                        you to limit the
                        download speed, only the upload. You will have to use a third-party solution, such as <a
                            class='altlink' href='redir.php?url=http://www.netlimiter.com/'>NetLimiter</a>.<br />
                        <br />
            ...
            <table border='1' width='100%' cellspacing='0' cellpadding='10'>
                <tr>
                    <td class='text'>
                        ...
                        <br />
                        Short reply: change to an ISP that does not force a proxy upon you. If you cannot or do not want
                        to then read on.<br />
                        <br />
                        <span style='font-weight:bold;'>What is a proxy?</span><a name='prox1'></a><br />
                        <br />
                        Basically a middleman. When you are browsing a site through a proxy your requests are sent to
                        the proxy and the proxy forwards them to the site instead of you connecting directly to the
                        site. There are several classifications
                        ...
                        <table cellspacing='3' cellpadding='0'>
                            <tr>
                                ...
                                <td class='embedded' width='10'>&nbsp;</td>
                                <td class='embedded' valign='top'>A transparent proxy is one that needs no configuration
                                                                  on the clients. It works by automatically redirecting
                                                                  all port 80 traffic to the proxy. (Sometimes used as
                                                                  synonymous for non-anonymous.)
                                </td>
                            </tr>
                            <tr>
                                <td class='embedded' valign='top' bgcolor='#F5F4EA'>&nbsp;Explicit/Voluntary</td>
                                <td class='embedded' width='10'>&nbsp;</td>
                                <td class='embedded' valign='top'>Clients must configure their browsers to use them.
                                </td>
                            </tr>
                            <tr>
                                <td class='embedded' valign='top' bgcolor='#F5F4EA'>&nbsp;Anonymous</td>
                                <td class='embedded' width='10'>&nbsp;</td>
                                <td class='embedded' valign='top'>The proxy sends no client identification to the
                                                                  server. (HTTP_X_FORWARDED_FOR header is not sent; the
                            ...
                            <tr>
                                ...
                                <td class='embedded' width='10'>&nbsp;</td>
                                <td class='embedded' valign='top'>The proxy sends no client nor proxy identification to
                                                                  the server. (HTTP_X_FORWARDED_FOR, HTTP_VIA and
                                                                  HTTP_PROXY_CONNECTION headers are not sent; the server
                                                                  doesn't see your IP and doesn't even know you're using
                                                                  a proxy.)
                                </td>
                            </tr>
                            <tr>
                        ...
                        <br />
                        A transparent proxy may or may not be anonymous, and there are several levels of
                        anonymity.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>How do I find out if I'm behind a (transparent/anonymous) proxy?</span><a
                            name='prox2'></a><br />
                        <br />
                        Try <a href='redir.php?url=http://proxyjudge.org' class='altlink'>ProxyJudge</a>. It lists the
                        HTTP headers that the server where it is running received from you. The relevant ones are
                        HTTP_CLIENT_IP, HTTP_X_FORWARDED_FOR and REMOTE_ADDR.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Why am I listed as not connectable even though I'm not NAT/Firewalled?</span><a
                            name='prox3'></a><br />
                        <br />
                        The <span style='font-weight:bold;'><?php echo $site_name?></span> tracker is quite smart at
                        finding your real IP, but it does need the proxy to send the HTTP header HTTP_X_FORWARDED_FOR.
                        If your ISP's proxy does not then what happens is that the tracker will interpret the proxy's IP
                        address as the client's IP address. So when you login and the tracker tries to connect to your
                        client to see if you are NAT/firewalled it will actually try to connect to the proxy on the port
                        your client reports to be using for incoming connections. Naturally the proxy will not be
                        listening on that port, the connection will fail and the tracker will think you are
                        NAT/firewalled.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Can I bypass my ISP's proxy?</span><a name='prox4'></a><br />
                        <br />
                        If your ISP only allows HTTP traffic through port 80 or blocks the usual proxy ports then you
                        would need to use something like <a href='redir.php?url=http://www.socks.permeo.com'>socks</a>
                        and that is outside the scope of this FAQ.<br />
                        <br />
                        The site accepts connections on port 81 besides the usual 80, and using them may be enough to
                        fool some proxies. So the first thing to try should be connecting to <span
                            style='font-weight:bold;'><?php echo $site_url?>:81</span>. Note that even if this works
                        your BT client will still try to connect to port 80 unless you edit the announce url in the
                        .torrent file.<br />
                        <br />
                        Otherwise you may try the following:<br />
                        <ul>
                            <li>Choose any public <span style='font-weight:bold;'>non-anonymous</span> proxy that does
                                <span style='font-weight:bold;'>not</span> use port 80
                                ...
                                <a href='redir.php?url=http://www.samair.ru/proxy' class='altlink'>this</a> list).
                            </li>

                            <li>Configure your computer to use that proxy. For Windows XP, do <span
                                    style='font-style: italic;'>Start</span>, <span style='font-style: italic;'>Control Panel</span>,
                                <span style='font-style: italic;'>Internet Options</span>,
                                <span style='font-style: italic;'>Connections</span>, <span style='font-style: italic;'>LAN Settings</span>,
                                <span style='font-style: italic;'>Use a Proxy server</span>, <span
                                        style='font-style: italic;'>Advanced</span> and type in the IP and port of your
                                chosen proxy. or from Internet Explorer use <span
                                        style='font-style: italic;'>Tools</span>, <span style='font-style: italic;'>Internet Options</span>,
                                ...<br /></li>

                            <li>(Facultative) Visit <a href='redir.php?url=http://proxyjudge.org' class='altlink'>ProxyJudge</a>.
                                If you see an HTTP_X_FORWARDED_FOR in the list followed by your IP then everything
                                should be ok, otherwise choose another proxy and try again.<br /></li>

                            <li>Visit <span style='font-weight:bold;'><?php echo $site_name?></span>. Hopefully the
                                tracker will now pickup your real IP (check your profile to make sure).
                            </li>
                        </ul>
                        <br />
                        Notice that now you will be doing all your browsing through a public proxy, which are typically
                        quite slow. Communications between peers do not use port 80 so their speed will not be affected
                        by this, and should be better than when you were &quot;un connectable&quot;.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>How do I make my bittorrent client use a proxy?</span><a
                            name='prox5'></a><br />
                        <br />
                        Just configure Windows XP as above. When you configure a proxy for Internet Explorer you're
                        actually configuring a proxy for all HTTP traffic (thank Microsoft and their &quot;IE as part of
                        the OS policy&quot; ). On the other hand if you use another browser (Opera/Mozilla/Firefox) and
                        configure a proxy there you'll be configuring a proxy just for that browser. We don't know of
                        any BT client that allows a proxy to be specified explicitly.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Why can't I signup from behind a proxy?</span><a
                            name='prox6'></a><br />
                        It is our policy not to allow new accounts to be opened from behind a proxy.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Does this apply to other torrent sites?</span><a
                            name='prox7'></a><br />
                        <br />
                        This section was written for <span style='font-weight:bold;'><?php echo $site_name?></span>, a
                        closed, port 80-81 tracker. Other trackers may be open or closed, and many listen on e.g. ports
                        6868 or 6969. The above does <span style='font-weight:bold;'>not</span> necessarily apply to
                        other trackers.<br />
                    </td>
                </tr>
            </table>
            ...
            <table border='1' width='100%' cellspacing='0' cellpadding='10'>
                <tr>
                    <td class='text'>
                        ...
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Maybe my address is blacklisted?</span><a
                            name='conn2'></a><br />
                        <br />
                        The site blocks addresses listed in the (former) <a class='altlink'
                                                                            href='redir.php?url=http://methlabs.org/'>PeerGuardian</a>
                        database, as well as addresses of banned users. This works at Apache/PHP level, it's just a
                        script that blocks <span style='font-style: italic;'>logins</span> from those addresses. It
                        should not stop you from reaching the site. In particular it does not block lower level
                        protocols, you should be able to ping/traceroute the server even if your address is blacklisted.
                        If you cannot then the reason for the problem lies elsewhere.<br />
                        <br />
                        If somehow your address is indeed blocked in the PG database do not contact us about it, it is
                        not our policy to open <span style='font-style: italic;'>ad hoc</span> exceptions. You should
                        clear your IP with the database maintainers instead.<br />
                        <br />
                        <br />
                        <span style='font-weight:bold;'>Your ISP blocks the site's address</span><a
                            name='conn3'></a><br />
                        <br />
                        (In first place, it's unlikely your ISP is doing so. DNS name resolution and /or network
                        problems are the usual culprits.)
                        <br />
                        There's nothing we can do. You should contact your ISP (or get a new one). Note that you can
                        still visit the site via a proxy, follow the instructions in the relevant section. In this case
                        it doesn't matter if the proxy is anonymous or not, or which port it listens to.<br />
                        <br />
                        Notice that you will always be listed as an &quot;un connectable&quot; client because the
                        tracker will be unable to
                        ...
                        <br />
                        Some of our torrents use ports other than the usual HTTP port 80. This may cause problems for
                        some users, for instance those behind some firewall or proxy configurations.
                        ...
                        and replacing the announce url <span style='font-weight:bold;'><?php echo $site_url?>
                        :81/announce.php</span> with <span style='font-weight:bold;'><?php echo $site_url?>
                        :80/announce.php</span> or just <span
                            style='font-weight:bold;'><?php echo $site_url?></span>.<br />
                        <br />
                        Editing the .torrent with Notepad is not recommended. It may look like a text file, but it is in
                        fact a bencoded file. If for some reason you must use a plain text editor, change the announce
                        url to <span style='font-weight:bold;'><?php echo $site_url?>:80/announce.php</span>, not <span
                            style='font-weight:bold;'><?php echo $site_url?></span>. (If you're thinking about changing
                        the number before the announce url instead, you know too much to be reading this.)
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td class='embedded'>
            ...
            <table border='0' width='100%' cellspacing='0' cellpadding='10'>
                <tr>
                    <td class='text'>
                        <br />
                        Post in the <a class='altlink' href='forums.php'>Forums</a>, by all means. You'll find they are
                        usually a friendly and helpful place, provided you follow a few basic guidelines:
                        <ul>
                            <li>Make sure your problem is not really in this FAQ. There's no point in posting just to be
                                sent
                                back here.
                            </li>
                            <li>Before posting read the sticky topics (the ones at the top). Many times new information
                                that still hasn't been incorporated in the FAQ can be found there.
                            </li>
                            <li>Help us in helping you. Do not just say 'it doesn't work!'. Provide details so that we
                                don't have to guess or waste time asking. What client do you use? What's your OS? What's
                                your network setup? What's the exact error message you get, if any? What are the
                                torrents you are having problems with? The more you tell the easiest it will be for us,
            ...
            <p align='right'><span style='color : #004E98; font-size: x-small; font-weight:bold;'>FAQ edited 2011-09-30 (07:45 GMT)</span>
            </p>
