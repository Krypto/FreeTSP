...
$language_data = array('LANG_NAME'              => 'PureBasic',
                       'COMMENT_SINGLE'         => array(1 => ";"),
                       'COMMENT_MULTI'          => array(),
                       'CASE_KEYWORDS'          => GESHI_CAPS_NO_CHANGE,
                       'QUOTEMARKS'             => array('"'),
                       'ESCAPE_CHAR'            => '',
                       'KEYWORDS'               => array(1 => array(// Keywords
                           'And',
                           'As',
                           'Break',
                           'CallDebugger',
                           ...
                           'XOr'),
                                                         2 => array(// All Functions
                                                             ...
                                                             'egrid_ClearRows',
                                                             'egrid_CopyCells',
                                                             'egrid_CreateCellCallback',
                                                             'egrid_CreateGrid',
                                                             'egrid_DeleteCells',
                                                             'egrid_FastDeleteCells',
                                                             'egrid_FreeGrid',
                                                             'egrid_GetCellSelection',
                                                             'egrid_GetCellText',
                                                             'egrid_GetColumnOrderArray',
                                                             'egrid_HasSelectedCellChanged',
                                                             'egrid_Height',
                                                             'egrid_HideEdit',
                                                             'egrid_HideGrid',
                                                             'egrid_MakeCellVisible',
                                                             'egrid_NumberOfColumns',
                                                             'egrid_NumberOfRows',
                                                             'egrid_PasteCells',
                                                             'egrid_Register',
                                                             'egrid_RemoveCellCallback',
                                                             'egrid_RemoveColumn',
                                                             'egrid_RemoveRow',
                                                             'egrid_Resize',
                                                             'egrid_SelectCell',
                                                             'egrid_SelectedColumn',
                                                             'egrid_SelectedRow',
                                                             'egrid_SetCellSelection',
                                                             'egrid_SetCellText',
                                                             'egrid_SetColumnOrderArray',
                                                             'egrid_SetHeaderFont',
                                                             'egrid_SetHeaderHeight',
                                                             'egrid_SetOption',
                                                             'egrid_Width',
                                                             'egrid_x',
                                                             'egrid_y',
                                                             ...
                                                             'Reg_ListSubValue',
                                                             'Reg_ReadBinary',
                                                             'Reg_ReadExpandString',
                                                             'Reg_ReadLong',
                                                             'Reg_ReadMultiLineString',
                                                             'Reg_ReadQuad',
                                                             'Reg_ReadString',
                                                             'Reg_WriteBinary',
                                                             'Reg_WriteExpandString',
                                                             'Reg_WriteLong',
                                                             'Reg_WriteMultiLineString',
                                                             'Reg_WriteQuad',
                                                             'Reg_WriteString',
                                                             'ReleaseMouse',
                                                             'RemoveBillboard',
                       ...
                       'STYLES'                 => array('KEYWORDS'    => array(1 => 'color: #000066; font-weight: bold;',
                                                                                2 => 'color: #0000ff;',
                                                                                3 => 'color: #000fff;'),
                                                         'COMMENTS'    => array(1       => 'color: #ff0000; font-style: italic;',
