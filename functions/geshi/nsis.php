...
$language_data = array('LANG_NAME'              => 'NSIS',
                       ...
                       'QUOTEMARKS'             => array("'",
                                                         ...
                                                         '`'),
                       'ESCAPE_CHAR'            => '',
                       'KEYWORDS'               => array(1  => array('!appendfile',
                                                                     '!addIncludeDir',
                                                                     '!addplugindir',
                                                                     '!cd',
                                                                     '!define',
                                                         ...
                                                         7  => array('.onGUIEnd',
                                                                     ...
                                                                     'un.onUserAbort'),
                                                         8  => array('MUI.nsh',
                                                                     '"${NSISDIR}\Contrib\Modern UI\System.nsh"',
                                                                     'MUI_SYSVERSION',
                                                                     'MUI_ICON',
                                                                     'MUI_UNICON',
                                                                     'MUI_HEADERIMAGE',
                                                         ...
                                                         10 => array('StrFunc.nsh',
                                                                     ...
                                                                     '${StrTok}',
                                                                     '${StrTrimNewLines}'),
                                                         11 => array('UpgradeDLL.nsh',
                                                                     'UPGRADEDLL_INCLUDED',
                                                                     'UpgradeDLL'),
                                                         12 => array('Sections.nsh',
                                                                     'SECTIONS_INCLUDED',
                                                                     '${SF_SELECTED}',
                                                                     '${SF_SECGRP}',
                                                                     '${SF_SUBSEC}',
                       ...
                       'STYLES'                 => array('KEYWORDS'    => array(1  => 'color: #000066; font-weight:bold;',
                                                         ...
                                                         'ESCAPE_CHAR' => array(0 => 'color: #660066; font-weight: bold;'),
                                                         'BRACKETS'    => array(0 => ''),
                                                         'STRINGS'     => array(0 => 'color: #660066;'),
                                                         'NUMBERS'     => array(0 => ''),
                                                         'METHODS'     => array(0 => ''),
                                                         'SYMBOLS'     => array(0 => ''),
                                                         'REGEXPS'     => array(0 => 'color: #660000;',
                                                                                1 => 'color: #660000;',
                                                                                2 => 'color: #660000;',
                                                                                3 => 'color: #660000;',
                                                                                4 => 'color: #660000;',
                       ...
                       'REGEXPS'                => array(0 => '\$\$',
                                                         ...
                                                         5 => '\$\{.{1,256}\}',
                                                         6 => '\$\\\(.{1,256}\\\)',
                                                         7 => array(GESHI_SEARCH    => '([^:\/\\\*\?\"\<\>(?:<PIPE>)\s]*?)(::)([^:\/\\\*\?\"\<\>(?:<PIPE>)\s]*?)',
                                                                    GESHI_REPLACE   => '\\1',
                                                                    GESHI_MODIFIERS => '',
                                                                    GESHI_BEFORE    => '',
                                                                    GESHI_AFTER     => '\\2\\3'),
                                                         8 => array(GESHI_SEARCH    => '([^:\/\\\*\?\"\<\>(?:<PIPE>)\s]*?)(::)([^:\/\\\*\?\"\<\>(?:<PIPE>)]*?\s)',
                                                                    GESHI_REPLACE   => '\\3',
                                                                    GESHI_MODIFIERS => '',
                                                                    GESHI_BEFORE    => '\\1\\2',
                                                                    GESHI_AFTER     => '')),
