...
<form method='post' action='testip.php'>
    <table border='1' cellspacing='0' cellpadding='5'>
        <tr>
            <td class='rowhead'><label for='ip'>IP Address</label></td>
            <td><input type='text' name='ip' id='ip' size='15' /></td>
        </tr>
        <tr>
            <td class='rowhead' colspan='2' align='center'><input type='submit' class='btn' value='OK' /></td>
        </tr>
    </table>
</form>
