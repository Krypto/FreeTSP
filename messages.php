...
<table border="0" cellpadding="4" cellspacing="0" width='100%'>
    <tr>
        <td colspan='5'>
            <div align="left"><img src="<?php echo $image_dir?>unreadpm.gif" width='19' height='15' alt="Unread" title="Unread Meassages" /> Unread Messages.<br /> <img src="<?php echo $image_dir?>readpm.gif" width='19' height='15' alt="Read" title="Read Messages" /> Read Messages.
            </div>
            <div align="right">
...
if ($action == "forward")
{
    ...
    <form action="messages.php" method="post">
        ...
        <table border="0" cellpadding="4" cellspacing="0" width="100%">
            ...
            <tr>
                <td class="rowhead" colspan="2" align="left">Save Message <input type="checkbox" name="save" value="1"<?php echo $CURUSER['savepms'] == 'yes' ? " checked='checked'" : ""?> />&nbsp; <input type="submit" class="btn" value="Forward" /></td>
            </tr>
        </table>
    </form>
