...
function StatusBar()
{
    ...
    {
         $StatusBar = "<tr>"."<td colspan='2' style='padding: 2px;'>"."<div id='statusbar'>"."<p class='home'>Welcome back, ".format_username($CURUSER)."&nbsp; ".$usrclass."&nbsp;[<a href='logout.php'>Logout</a>] Invites: <a href='invite.php'>".htmlspecialchars($CURUSER['invites'])."</a> Reputation Points : ".$CURUSER['reputation']."</p>"."<p>".date(DATE_RFC822)."</p><p>";
    }
    else
    {
         $StatusBar = "<tr>"."<td colspan='2' style='padding: 2px;'>"."<div id='statusbar'>"."<p class='home'>Welcome back, ".format_username($CURUSER)."&nbsp; ".$usrclass."&nbsp;[<a href='logout.php'>Logout</a>] Invites: <a href='invite.php'>".htmlspecialchars($CURUSER['invites'])."</a></p>"."<p>".date(DATE_RFC822)."</p><p>";
    }
