 ...
 * perl6.php
 * ---------
 * Author: Kodi Arfer (kodiarfer {at} warpmail {period} net); forked from perl.php 1.0.8 by and reas Gohr (andi@splitbrain.org), Ben Keen (ben.keen@gmail.com)
 * Copyright: (c) 2009 Kodi Arfer, (c) 2004 and reas Gohr, Ben Keen (http://www.benjaminkeen.org/), Nigel McNie (http://qbnz.com/highlighter/)
...
$language_data = array('LANG_NAME'              => 'Perl 6',
                       'COMMENT_SINGLE'         => array(1 => '#'),
                       'COMMENT_MULTI'          => array('=begin' => '=end'),
                       'COMMENT_REGEXP'         => array(//Regular expressions
                       ...
                       'HARDQUOTE'              => array("'",
                                                         "'"),
    // An optional 2-element array defining the beginning and end of a hard-quoted string
                       'HARDESCAPE'             => array('\\\''),
