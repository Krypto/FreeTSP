...
<tr>
    <td class='embedded'>
        ...
        <table border='1' width='100%' cellspacing='0' cellpadding='10'>
            <tr>
                <td class='text'>
                    <span style='font-weight:bold;'>CAM -</span><br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span style='font-weight:bold;'>TELESYNC (TS) -</span><br />
                    <br />
                    ...
                    A lot of the times a telesync is filmed in an empty cinema or from the projection booth with a professional camera, giving a better picture quality. Quality ranges drastically, check the sample before downloading the full release. A high percentage of Telesyncs are CAMs that have been mislabeled.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>TELECINE (TC) -</span><br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span style='font-weight:bold;'>SCREENER (SCR) -</span><br />
                    <br />
                    A pre VHS tape, sent to rental stores, and various other places for promotional use.  A screener is supplied on a VHS tape, and is usually in a 4:3 (full screen) a/r, although letterboxed screeners are sometimes found. The main draw back is a "ticker" (a message that scrolls past at the bottom of the screen, with the copyright and anti-copy telephone number). Also, if the tape contains any serial numbers, or any other markings that could lead to the source of the tape, these will have to be blocked, usually with a black mark over the section. This is sometimes only for a few seconds, but unfortunately on the equipment used, screener quality can range from excellent if done from a MASTER copy, to very poor if done on an old VHS recorder thru poor capture equipment on a copied tape. Most screeners are transferred to VCD, but a few attempts at SVCD have occurred, some looking better than others.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>DVD-SCREENER (DVDscr) -</span><br />
                    <br />
                    Same premise as a screener, but transferred off a DVD. Usually letterbox , but without the extras that a DVD retail would contain. The ticker is not usually in the black bars, and will disrupt the viewing. If the ripper has any skill, a DVDscr should be very good.  Usually transferred to SVCD or DivX/XviD.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>DVDRip -</span><br />
                    <br />
                    A copy of the final released DVD. If possible this is released PRE retail (for example, Star Wars episode 2) again, should be excellent quality. DVDrips are released in SVCD and DivX/XviD.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>VHSRip -</span><br />
                    <br />
                    Transferred off a retail VHS, mainly skating/sports videos and XXX releases.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>TVRip -</span><br />
                    <br />
                    TV episode that is either from Network (capped using digital cable/satellite boxes are preferable) or PRE-AIR from satellite feeds sending the program around to networks a few days earlier (do not contain "dogs" but sometimes have flickers etc) Some programs such as WWF Raw Is War contain extra parts, and the "dark matches" and camera/commentary tests are included on the rips. PDTV is capped from a digital TV PCI card, generally giving the best results, and groups tend to release in SVCD for these. VCD/SVCD/DivX/XviD rips are all supported by the TV scene.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>WORKPRINT (WP) -</span><br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span style='font-weight:bold;'>DivX Re-Enc  -</span><br />
                    <br />
                    A DivX re-enc is a film that has been taken from its original VCD source, and re-encoded into a small DivX file. Most commonly found on file sharers, these are usually labeled something like Film.Name.Group(1of2) etc. Common groups are SMR and TND. These aren't really worth downloading, unless you're that unsure about a film u only want a 200mb copy of it. Generally avoid.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>Watermarks -</span><br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span style='font-weight:bold;'>Asian Silvers /   PDVD -</span><br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span style='font-weight:bold;'>Scene Tags...</span><br />
                    <br />
                    <span style='font-weight:bold;'>PROPER -</span><br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span style='font-weight:bold;'>LIMITED -</span><br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span style='font-weight:bold;'>NUKE REASONS...</span><br />
                    <br />
                    this is a list of common reasons a film can be nuked for (generally DVDRip)<br />
                    <br />
                    <span style='font-weight:bold;'>BAD A/R</span> = bad aspect ratio, ie people appear too fat/thin<br />
                    <span style='font-weight:bold;'>BAD IVTC</span> = bad inverse telecine. process of converting framerates was incorrect.<br />
                    <span style='font-weight:bold;'>INTERLACED</span> = black lines on movement as the field order is
                    incorrect.<br />
                    <br />
                    <br />
                    <span style='font-weight:bold;'>DUPE -</span><br />
                    <br />
