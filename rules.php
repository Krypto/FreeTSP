...
<ul>
    ...
    <li>Do NOT upload our torrents to other trackers! (See the <a href='faq.php#up3' class='altlink'><span style='font-weight:bold;'>FAQ</span></a> for details.)
    </li>
    <li><a name='warning' id="warning1"></a>Disruptive behaviour in the forums will result in a Warning (<img src='<?php echo $image_dir?>warned.png' width='16' height='16' border='0' alt='Warned' title='Warned' /> ).<br /> You will only get <span style='font-weight:bold;'>one</span> Warning! After that it's Bye Bye!
    </li>
</ul>
...
<ul>
    <li>Access to the newest torrents is conditional on a good Ratio! (See the <a href='faq.php#dl8' class='altlink'><span style='font-weight:bold;'>FAQ</span></a> for details.)
    </li>
...
<ul>
    ...
    <li>Make sure not to include any Serial Numbers, CD Keys or similar in the description (you do <span style='font-weight:bold;'>not</span> need to edit the NFO!).
    </li>
...
<br />
<div style="margin-left: 2em">If you have something interesting that somehow violate these Rules (e.g. not ISO format), ask a Mod and we might make an exception.
</div>
...
<table border='0' cellspacing='3' cellpadding='0'>
    <tr>
        ...
        <td class='embedded'>Automatically given to (and revoked from) users who have been members for at least 4 weeks, have uploaded at least 25 GB and have a share ratio above 1.05. Moderator changes of status last only until the next execution of the script.
        </td>
    </tr>
    <tr>
        ...
        <td class='embedded' width='5'>&nbsp;</td>
        <td class='embedded'>This status is given ONLY by Sysops since they are the only one's who can verify that they actually donated something.
        </td>
    </tr>
    <tr>
        <td class='embedded' bgcolor='#F5F4EA' valign='top'>&nbsp; <span style='font-weight:bold;'>VIP</span></td>
        <td class='embedded' width='5'>&nbsp;</td>
        <td class='embedded'>Conferred to users you feel contribute something special to the site. (Anyone begging for VIP status will be automatically disqualified)
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class='embedded' width='5'>&nbsp;</td>
        <td class='embedded'>Appointed by Admins/SysOp. Send a PM to <a class='altlink' href='sendmessage.php?receiver=1'>Admin</a> if you think you've got a good candidate.
        </td>
    </tr>
    <tr>
        <td class='embedded' bgcolor='#F5F4EA' valign='top'>&nbsp; <span style='font-weight:bold;'><span style='color : #A83838;'>Moderator</span></span></td>
        <td class='embedded' width='5'>&nbsp;</td>
        <td class='embedded'>Appointed by Admin only. If you think you've got a good candidate, send him a <a class='altlink' href='sendmessage.php?receiver=1'>PM</a>.
        </td>
    </tr>
</table>
<br />
...
<ul>
    ...
    <li><span style='font-weight:bold;'>Always</span> state a Reason (in the user comment box) as to why the Member is being Banned / Warned.
    </li>
...
<p align='right'><span style='color : #004E98; font-size: x-small;'><span style='font-weight:bold;'>Rules edited 2011-10-02 (22:24 GMT)</span></span>
</p>
