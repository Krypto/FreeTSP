...
$language_data = array('LANG_NAME'              => 'J',
                       'COMMENT_SINGLE'         => array(),
                       'COMMENT_MULTI'          => array(),
                       'COMMENT_REGEXP'         => array(1 => '/(?<!\w)NB\..*?$/m',
                           //singleline comments NB.
                                                         2 => '/(?<=\bNote\b).*?$\s+\)(?:(?!\n)\s)*$/sm',
                           //multiline comments in Note
                                                         3 => "/'[^']*?$/m"
                           //incomplete strings/open quotes
                       ),
                       ...
                       'HARDESCAPE'             => array("'"),
                       'HARDCHAR'               => "'",
                       'NUMBERS'                => array(//Some instances of infinity are not correctly handled by GeSHi NUMBERS currently
                       ...
                       'STYLES'                 => array('KEYWORDS'    => array(1 => 'color: #0000ff; font-weight: bold;',
                           ...
                           //            8 => 'color: #000000; font-weight: bold;',
                                                         ...
                                                         'ESCAPE_CHAR' => array('HARD' => 'font-weight: bold;',
                                                                                0      => '',),
                                                         'BRACKETS'    => array(0 => 'color: #009900;'),
                                                         'STRINGS'     => array('HARD' => 'color: #ff0000;',
                                                                                0      => 'color: #ff0000;',),
                                                         'NUMBERS'     => array(0 => 'color: #009999; font-weight: bold;'),
                                                         'METHODS'     => array(),
                                                         'SYMBOLS'     => array(0 => 'color: #009900; font-weight: bold;'),
                                                         'REGEXPS'     => array(0 => 'color: #0000ff; font-weight: bold;',
                                                             //for_xyz. - same as kw1
                                                                                1 => 'color: #009999; font-weight: bold;'
                                                             //infinity - same as nu0
                                                         ),
                                                         'SCRIPT'      => array()),
                       'URLS'                   => array(1 => '',
                       ...
                       'REGEXPS'                => array(0 => '\b(for|goto|label)_[a-zA-Z]\w*\.',
                           //for_xyz. - should be kw1
                                                         1 => '\b__?(?![\w\.\:])'
                           //infinity - should be nu0
                       ),
                       ...
                       'PARSER_CONTROL'         => array('ENABLE_FLAGS' => array('BRACKETS' => GESHI_NEVER,),
                                                         'KEYWORDS'     => array(//Control words
                                                             2 => array('DISALLOWED_BEFORE' => '(?<!\w)',
                                                                        'DISALLOWED_AFTER'  => '(?![\w\.\:])',),
                                                             //Primtives starting with a symbol (except . or :)
                                                             6 => array('DISALLOWED_BEFORE' => '(?!K)',
                                                                 // effect should be to allow anything
                                                                        'DISALLOWED_AFTER'  => '(?=.*)',),
                                                             //Primtives starting with a letter
                                                             7 => array('DISALLOWED_BEFORE' => '(?<!\w)',
                                                                        'DISALLOWED_AFTER'  => '(?=.*)',),
                                                             //Primtives starting with symbol . or :
                                                             8 => array('DISALLOWED_BEFORE' => '(?<=\s)',
                                                                        'DISALLOWED_AFTER'  => '(?=.*)',),)));
