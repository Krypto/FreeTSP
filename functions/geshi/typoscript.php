...
$language_data = array('LANG_NAME'              => 'TypoScript',
                       ...
                       'QUOTEMARKS'             => array(),
                       'ESCAPE_CHAR'            => '',
                       'KEYWORDS'               => array(// Conditions: http://documentation.typo3.org/documentation/tsref/conditions/
                           1 => array('browser',
                                      'compatVersion',
                                      'dayofmonth',
                                      'dayofweek',
                           ...
                           8 => array('alternativeSortingField',
                                      'begin',
                                      'debugItemConf',
                                      'imgNameNotRandom',
                                      'imgNamePrefix',
    ...
    // lib.nav-sub
                       ...
                       'CASE_SENSITIVE'         => array(GESHI_COMMENTS => false,
                                                         ...
                                                         8              => true,
                                                         9              => true),
                       'STYLES'                 => array('KEYWORDS'    => array(1 => 'color: #ed7d14;',
                                                                                2 => 'font-weight: bold;',
                                                         ...
                                                         'ESCAPE_CHAR' => array(),
                                                         'SCRIPT'      => array()),
                       'URLS'                   => array(1 => 'http://documentation.typo3.org/documentation/tsref/conditions/{FNAME}/',
                       ...
                       'REGEXPS'                => array(// Constant
                           0 => array(GESHI_SEARCH    => '(\{)(\$[a-zA-Z_\.]+[a-zA-Z0-9_\.]*)(\})',
                                      GESHI_REPLACE   => '\\2',
                                      GESHI_MODIFIERS => '',
                                      GESHI_BEFORE    => '\\1',
                                      GESHI_AFTER     => '\\3'),
                           ...
                           1 => array(GESHI_SEARCH    => '(\$)([a-zA-Z_\.]+[a-zA-Z0-9_\.]*)',
                                      GESHI_REPLACE   => '\\1',
                                      GESHI_MODIFIERS => '',
                                      GESHI_BEFORE    => '',
                                      GESHI_AFTER     => '\\2'),
                           ...
                           3 => array(GESHI_SEARCH    => '(plugin\.|[^\.]\b)((?:static|user|ttx|tx|tt|fe)(?:_[0-9A-Za-z_]+?)\b)',
                                      GESHI_REPLACE   => '\\2',
                                      GESHI_MODIFIERS => '',
                                      GESHI_BEFORE    => '\\1',
                                      GESHI_AFTER     => ''),
                           ...
                           4 => array(GESHI_SEARCH    => '(\[)(globalVar|global|end)\b',
                                      GESHI_REPLACE   => '\\2',
                                      GESHI_MODIFIERS => 'i',
                                      GESHI_BEFORE    => '\\1',
                                      GESHI_AFTER     => ''),
                           ...
                           5 => array(GESHI_SEARCH    => '([^\.\$-\{]\b)(cObj|field|config|content|file|frameset|includeLibs|lib|page|plugin|register|resources|sitemap|sitetitle|styles|temp|tt_content|tt_news|types|xmlnews)\b',
                                      GESHI_REPLACE   => '\\2',
                                      GESHI_MODIFIERS => '',
                                      GESHI_BEFORE    => '\\1',
                                      GESHI_AFTER     => ''),
                           ...
                           // hex color codes
                           7 => array(GESHI_SEARCH    => '(#[a-fA-F0-9]{6}\b|#[a-fA-F0-9]{3}\b)',
                                      GESHI_REPLACE   => '\\1',
                                      GESHI_MODIFIERS => '',
                                      GESHI_BEFORE    => '',
                                      GESHI_AFTER     => '')),
