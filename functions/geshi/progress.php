...
$language_data = array('LANG_NAME'              => 'Progress',
                       ...
                       'QUOTEMARKS'             => array("'",
                                                         '"'),
                       'ESCAPE_CHAR'            => '',
                       'KEYWORDS'               => array(1 => array('ACCUMULATE',
                                                                    'APPLY',
                                                                    'ASSIGN',
                                                                    'BELL',
                                                                    'QUERY',
                       ...
                       'TAB_WIDTH'              => 4,
                       'PARSER_CONTROL'         => array('KEYWORDS' => array('DISALLOWED_BEFORE' => "(?<![\.\-a-zA-Z0-9_\$\#&])",
                                                                             'DISALLOWED_AFTER'  => "(?![\-a-zA-Z0-9_%])",
                                                                             1                   => array('SPACE_AS_WHITESPACE' => true),
                                                                             2                   => array('SPACE_AS_WHITESPACE' => true))));
