 ...
 *
 * Based on original MySQL language file by Carl F�rstenberg (2004); brought
...
$language_data = array('LANG_NAME'              => 'MySQL',
    //'COMMENT_SINGLE' => array(1 =>'--', 2 => '#'),    // '--' MUST be folowed by whitespace,not necessarily a space
                       'COMMENT_SINGLE'         => array(1 => '-- ',
                                                         2 => '#'),
                       'COMMENT_REGEXP'         => array(1 => "/(?:--\s).*?$/",
                           // double dash followed by any whitespace
                       ),
                       'COMMENT_MULTI'          => array('/*' => '*/'),
    ...
    // @@@ would be nice if this could be defined per group!
                       'QUOTEMARKS'             => array("'",
                                                         ...
                                                         '`'),
                       'ESCAPE_CHAR'            => '\\',
    // by default only, can be specified
                       'ESCAPE_REGEXP'          => array(1 => "/[_%]/",
                           // search wildcards
                       ),
                       ...
                       'KEYWORDS'               => array(1  => array(// Mix: statement keywords and keywords that don't fit in any other
                           ...
                           'WRITE',),
                                                         ...
                                                         11 => array( //No ( must follow
                                                             ...
                                                             "INTERVAL"),
                                                         12 => array(// Control Flow (functions)
                                                             'CASE',
                                                             'ELSE',
                                                             'END',
                                                             'IFNULL',
                                                         ...
                                                         16 => array( //A ( must follow
                                                             ...
                                                             "TRUNCATE"),
                                                         17 => array(// Date and Time Functions
                                                             'ADDDATE',
                                                             'ADDTIME',
                                                             'CONVERT_TZ',
                                                             'CURDATE',
