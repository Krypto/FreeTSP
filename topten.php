...
<?php
    ...
    while ($a = mysql_fetch_assoc($res))
    {
        ...
        echo("<tr $highlight><td class='rowhead' align='center'>$num</td><td class='rowhead' align='left' $highlight><a href='userdetails.php?id=".$a["userid"]."'><span    style='font-weight:bold;'>".$a["username"]."</span></a>"."</td><td class='rowhead' align='right'    $highlight>".mksize($a["uploaded"])."</td><td class='rowhead' align='right' $highlight>".mksize($a["upspeed"])."/s"."</td><td class='rowhead' align='right  '$highlight>".mksize($a["downloaded"])."</td><td class='rowhead' align='right   '$highlight>".mksize($a["downspeed"])."/s"."</td><td class='rowhead' align='right'  $highlight>".$ratio."</td><td class='rowhead' align='left'>".gmdate("Y-m-d", strtotime($a['added']))." (".get_elapsed_time(sql_timestamp_to_unix_timestamp($a['added']))." ago)</td></tr>");
    }
    end_table();
    end_frame();
}
...
<?php
    ...
    while ($a = mysql_fetch_assoc($res))
    {
        ...
        echo("<tr><td class='rowhead' align='center'>$num</td><td class='rowhead' align='left'><a href='details.php?id=".$a["id"]."&hit=1'><span style='font-weight:bold;'>".$a["name"]."</span></a></td><td class='rowhead' align='right'>".number_format($a["times_completed"])."</td><td class='rowhead' align='right'>".mksize($a["data"])."</td><td align='right'>".number_format($a["seeders"])."</td><td  class='rowhead' align='right'>".number_format($a["leechers"])."</td><td align='right'>".($a["leechers"] + $a["seeders"])."</td><td  class='rowhead' align='right'>$ratio</td>\n");
    }
    end_table();
    end_frame();
}
    ...
    <tr>
        <td class='std' align='center'>
            <div id='FreeTSP5' class='FreeTSPglidecontenttoggler5'>
                <div style="text-align: center; text-decoration: underline;">Members</div>
                <br />
                ...
                <div style="text-align: center; text-decoration: underline;">Torrents</div>
                <br />
                ...
                <div style="text-align: center; text-decoration: underline;">Countries</div>
                <br />
