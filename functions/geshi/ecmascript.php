...
$language_data = array('LANG_NAME'              => 'ECMAScript',
    ...
    // Regular Expression Literals
                       ...
                       'KEYWORDS'               => array(1 => array( // Reserved literals
                           'false',
                           'true',
                           'null'),
                       ...
                       'CASE_SENSITIVE'         => array(GESHI_COMMENTS => false,
                                                         ...
                                                         7              => true,
                                                         8              => true),
                       'STYLES'                 => array('KEYWORDS'    => array(1 => 'color: #009999;',
                                                                                2 => 'color: #1500C8;',
                                                                                3 => 'color: #1500C8;',
                                                                                4 => 'color: #1500C8;',
                                                                                5 => 'color: #1500C8;',
                                                         ...
                                                         'ESCAPE_CHAR' => array(0      => 'color: #3366CC;',
                                                                                1      => 'color: #3366CC;',
                                                                                2      => 'color: #3366CC;',
                                                                                3      => 'color: #3366CC;',
                                                                                4      => 'color: #3366CC;',
                                                                                5      => 'color: #3366CC;',
                                                                                'HARD' => '',),
                                                         'BRACKETS'    => array(0 => 'color: #008800;'),
                                                         'STRINGS'     => array(0 => 'color: #9900FF;'),
                                                         'NUMBERS'     => array(0                          => 'color: #FF00FF;',
