...
{
    $staff_class[$arr['class']] = $staff_class[$arr['class']]."<table class='main' width='100%' cellspacing='0' cellpadding='5' border='0'><tr><td class='std' align='center' width='33%'><a class='altlink' href='userdetails.php?id=".$arr['id']."'>".$arr['username']."</a></td><td class='std' align='center' width='33%'> ".("'".$arr['last_access']."'" > $dt ? "<img src='".$image_dir."online.png' width='32' height='32' border='0' alt='Online' title='Online' />" : "<img src='".$image_dir."offline.png' width='32' height='32' border='0' alt='Offline' title='Offline' />")."</td>"."<td class='std' align='center' width='33%'><a href='sendmessage.php?receiver=".$arr['id']."'><input type='submit' class='btn' value='PM' /></a></td></tr></table><br />";
}
