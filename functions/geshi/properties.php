...
$language_data = array('LANG_NAME'              => 'PROPERTIES',
                       'COMMENT_SINGLE'         => array(1 => '#'),
                       'COMMENT_MULTI'          => array(),
                       'CASE_KEYWORDS'          => GESHI_CAPS_NO_CHANGE,
                       'QUOTEMARKS'             => array('"'),
                       'ESCAPE_CHAR'            => '',
                       'KEYWORDS'               => array(/* Common used variables */
                           1 => array('${user.home}'),),
                       'SYMBOLS'                => array('[',
                                                         ']',
                                                         '='),
                       'CASE_SENSITIVE'         => array(GESHI_COMMENTS => false,
                                                         1              => true),
                       'STYLES'                 => array('KEYWORDS'    => array(1 => 'font-weight: bold;',),
                                                         ...
                                                         'REGEXPS'     => array(0 => 'color: #000080; font-weight:bold;',
                                                                                1 => 'color: #008000; font-weight:bold;'),
                                                         'SCRIPT'      => array(0 => '')),
                       'URLS'                   => array(1 => ''),
                       'OOLANG'                 => false,
                       'OBJECT_SPLITTERS'       => array(),
                       'REGEXPS'                => array(//Entry names
                           0 => array(GESHI_SEARCH    => '^(\s*)([.a-zA-Z0-9_\-]+)(\s*=)',
                                      GESHI_REPLACE   => '\\2',
                                      GESHI_MODIFIERS => 'm',
                                      GESHI_BEFORE    => '\\1',
                                      GESHI_AFTER     => '\\3'),
                           //Entry values
                           1 => array(// Evil hackery to get around GeSHi bug: <>" and ; are added so <span>s can be matched
