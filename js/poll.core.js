function loadpoll()
{
    ...
    $("#poll_container").fadeIn("slow", function ()
    {
        ...
        $.post("/poll.core.php", {action:"load"}, function (r)
        {
            $("#poll_container").html(r);
...
function vote()
{
    ...
    $("#loading_poll").fadeIn("fast", function ()
    {
        $("#loading_poll").html("Please wait while your vote is stored...");
    });
