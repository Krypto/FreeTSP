...
else
{
    ...
    print("<tr>
            ...
            <td class='rowhead'><input type='radio' name='nfoaction' value='keep' checked='checked' />Keep current<br />"."<input type='radio' name='nfoaction' value='update' />Update:<br /><input type='file' name='nfo' size='80' /></td>
        </tr>");
