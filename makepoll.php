...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    {
        sql_query("INSERT INTO polls VALUES(0".", '".get_date_time()."'".", ".sqlesc($question).", ".sqlesc($option0).", ".sqlesc($option1).", ".sqlesc($option2).", ".sqlesc($option3).", ".sqlesc($option4).", ".sqlesc($option5).", ".sqlesc($option6).", ".sqlesc($option7).", ".sqlesc($option8).", ".sqlesc($option9).", ".sqlesc($option10).", ".sqlesc($option11).", ".sqlesc($option12).", ".sqlesc($option13).", ".sqlesc($option14).", ".sqlesc($option15).", ".sqlesc($option16).", ".sqlesc($option17).", ".sqlesc($option18).", ".sqlesc($option19).", ".sqlesc($sort).")") or sqlerr(__FILE__, __LINE__);
    }
...
<form method='post' action='makepoll.php'>
    <table align='center' border='1' cellspacing='0' cellpadding='5'>
        <tr>
            ...
            <td class='rowhead' align='left'><input name='question' size='80' maxlength='255' value="<?php echo isset($poll['question']) ? $poll['question'] : ''?>" />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 1 <span style='color : #ff0000;'>*</span></td>
            <td class='rowhead' align='left'><input name='option0' size='80' maxlength='40' value="<?php echo isset($poll['option0']) ? $poll['option0'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 2 <span style='color : #ff0000;'>*</span></td>
            <td class='rowhead' align='left'><input name='option1' size='80' maxlength='40' value="<?php echo isset($poll['option1']) ? $poll['option1'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 3</td>
            <td class='rowhead' align='left'><input name='option2' size='80' maxlength='40' value="<?php echo isset($poll['option2']) ? $poll['option2'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 4</td>
            <td class='rowhead' align='left'><input name='option3' size='80' maxlength='40' value="<?php echo isset($poll['option3']) ? $poll['option3'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 5</td>
            <td class='rowhead' align='left'><input name='option4' size='80' maxlength='40' value="<?php echo isset($poll['option4']) ? $poll['option4'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 6</td>
            <td class='rowhead' align='left'><input name='option5' size='80' maxlength='40' value="<?php echo isset($poll['option5']) ? $poll['option5'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 7</td>
            <td class='rowhead' align='left'><input name='option6' size='80' maxlength='40' value="<?php echo isset($poll['option6']) ? $poll['option6'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 8</td>
            <td class='rowhead' align='left'><input name='option7' size='80' maxlength='40' value="<?php echo isset($poll['option7']) ? $poll['option7'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 9</td>
            <td class='rowhead' align='left'><input name='option8' size='80' maxlength='40' value="<?php echo isset($poll['option8']) ? $poll['option8'] : ''?>" /><br />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class='rowhead' align='left'><input name='option9' size='80' maxlength='40' value="<?php echo isset($poll['option9']) ? $poll['option9'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 11</td>
            <td class='rowhead' align='left'><input name='option10' size='80' maxlength='40' value="<?php echo isset($poll['option10']) ? $poll['option10'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 12</td>
            <td class='rowhead' align='left'><input name='option11' size='80' maxlength='40' value="<?php echo isset($poll['option11']) ? $poll['option11'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 13</td>
            <td class='rowhead' align='left'><input name='option12' size='80' maxlength='40' value="<?php echo isset($poll['option12']) ? $poll['option12'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 14</td>
            <td class='rowhead' align='left'><input name='option13' size='80' maxlength='40' value="<?php echo isset($poll['option13']) ? $poll['option13'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 15</td>
            <td class='rowhead' align='left'><input name='option14' size='80' maxlength='40' value="<?php echo isset($poll['option14']) ? $poll['option14'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 16</td>
            <td class='rowhead' align='left'><input name='option15' size='80' maxlength='40' value="<?php echo isset($poll['option15']) ? $poll['option15'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 17</td>
            <td class='rowhead' align='left'><input name='option16' size='80' maxlength='40' value="<?php echo isset($poll['option16']) ? $poll['option16'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 18</td>
            <td class='rowhead' align='left'><input name='option17' size='80' maxlength='40' value="<?php echo isset($poll['option17']) ? $poll['option17'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 19</td>
            <td class='rowhead' align='left'><input name='option18' size='80' maxlength='40' value="<?php echo isset($poll['option18']) ? $poll['option18'] : ''?>" /><br />
            </td>
        </tr>

        <tr>
            <td class='rowhead'>Option 20</td>
            <td class='rowhead' align='left'><input name='option19' size='80' maxlength='40' value="<?php echo isset($poll['option19']) ? $poll['option19'] : ''?>" /><br />
            </td>
        </tr>
        ...
        <tr>
            <td class='rowhead' colspan='2' align='center'><input type='submit' class='btn' value=<?php echo $pollid ? "'Edit Poll'" : "'Create Poll'"?> style='height: 20pt' />
            </td>
        </tr>
    </table>
