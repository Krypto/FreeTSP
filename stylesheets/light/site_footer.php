...
if (get_user_class() >= UC_SYSOP)
{
    ...
    if ($qtme['query_stat'])
    {
                 ...
                 $value)
        {
            ...
            <td align='center'><span style='font-weight:bold;'>".($value['seconds'] > 0.01 ? "<span style='color : #ff0000;' title='You should optimize this query.'>".$value['seconds']."</span>" : "<span style='color : green;' title='Query good.'>".$value['seconds']."</span>")."</span></td>
