...
//-- Query Stats --//
    ...
    echo("<a href='http://www.freetsp.info/topic/2091-clean/' target='_blank'>Clean</a> Theme Ported By Nicky.<br />
         Modified For <a href='http://www.freetsp.info/' target='_blank' title='FreeTSP V0.1'>V0.1</a> By Fireknight.");
    echo("<br /><br />");
